...
* Menghapus terjemahan Flarum core yang sudah usang (versi `2.0` atau di atasnya).
* Menghapus terjemahan untuk validasi (versi `2.0` atau di atasnya).
...
**Memperbarui dan/atau menghapus terjemahan yang sudah usang pada ekstensi**:
...
**Menghapus dukungan untuk ekstensi yang sudah usang**:
...
Semua perubahan: [1.34.3...2.0.0](https://github.com/flarum-lang/indonesian/compare/1.34.3...2.0.0).
